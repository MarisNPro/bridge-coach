...
const POOL = [
  ...
  { id: 'resp-1d-over-2c',         auction: ['1D', '(2C)'],           seat: 'responder' },
  { id: 'resp-1h-over-2c',         auction: ['1H', '(2C)'],           seat: 'responder' },
  { id: 'resp-1h-over-2d',         auction: ['1H', '(2D)'],           seat: 'responder' },
  { id: 'resp-1s-over-2c',         auction: ['1S', '(2C)'],           seat: 'responder' },
  { id: 'resp-1s-over-2d',         auction: ['1S', '(2D)'],           seat: 'responder' },
  { id: 'resp-1s-over-2h',         auction: ['1S', '(2H)'],           seat: 'responder' },

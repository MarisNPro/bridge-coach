...
**Acceptance criteria**
- `natural-v1.yaml` holds ~71 situations and ~471 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 164 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint

...
**Acceptance criteria**
- `natural-v1.yaml` holds ~82 situations and ~522 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 197 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint

...
**Acceptance criteria**
- `natural-v1.yaml` holds ~86 situations and ~534 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 207 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint

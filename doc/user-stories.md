...
**Acceptance criteria**
- `natural-v1.yaml` holds ~92 situations and ~564 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 229 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint

...
**Acceptance criteria**
- `natural-v1.yaml` holds ~80 situations and ~518 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 191 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint

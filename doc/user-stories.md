...
**Acceptance criteria**
- `natural-v1.yaml` holds ~76 situations and ~494 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 178 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint

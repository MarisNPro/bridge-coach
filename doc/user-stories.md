...
**Acceptance criteria**
- `natural-v1.yaml` holds ~98 situations and ~590 priority-ordered rules; only the `conditions`
...
**Acceptance criteria**
- Engine: 245 pytest cases — parity, coverage (no null calls), HTTP-boundary for every endpoint
